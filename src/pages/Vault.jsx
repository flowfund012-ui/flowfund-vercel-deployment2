    ...
    return (
        <div className="min-h-screen bg-vault text-platinum antialiased font-rajdhani">
            ...
            <div className={`container mx-auto px-4 py-12 max-w-7xl relative ${vaultOpen ? '' : 'hidden'}`}>
                    ...
                    {filteredAssets.map(asset => (
                        <div key={asset.id} className="asset-card vault-glass rounded-xl overflow-hidden border border-gray-800 transition-all duration-300">
                            ...
                            <div className="p-6">
                                ...
                                `}>
                                    <Download className="mr-2" size={20} /> Download Asset
                                </button>
                            </div>
                        </div>
                    ))}
                ...
                {/* Support Section */}
                <section className="text-center vault-glass rounded-xl p-8">
                    <h2 className="text-3xl font-bold text-neon mb-4">Need Assistance?</h2>
                    <p className="text-gray-300 mb-6">Our support team is ready to help you navigate the FlowFund Vault.</p>
                    <button className="px-8 py-3 rounded-lg font-medium bg-neon/20 text-neon border border-neon/30 hover:bg-neon/30 transition-colors">
                        <MessageSquare className="inline-block mr-2" size={20} /> Contact Support
                    </button>
                </section>
            </div>

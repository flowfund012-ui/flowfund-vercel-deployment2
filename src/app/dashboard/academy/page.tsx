            ...
            return(
              <div key={course.id} style={{background:'rgba(13,17,23,.9)',border:`1px solid ${completed?'rgba(16,185,129,.3)':started?`${col}30`:locked?'rgba(255,215,0,.12)':'rgba(255,255,255,.07)'}`,borderRadius:16,padding:22,display:'flex',flexDirection:'column',transition:'border-color .18s'}} onMouseEnter={e=>{if(!locked)(e.currentTarget as HTMLElement).style.borderColor=col+'44';}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.borderColor=completed?'rgba(16,185,129,.3)':started?`${col}30`:locked?'rgba(255,215,0,.12)':'rgba(255,255,255,.07)';}}>
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:12}}>
                  <div <div style={{width:40,height:40,borderRadius:12,background:`${col}18`,border:`1.5px solid ${col}40`,display:'flex',alignItems:'center',justifyContent:'center'}}><svg width="18" height="18" viewBox="0 0 20 20" fill="none"><path d="M4 3h12a1 1 0 0 1 1 1v1H3V4a1 1 0 0 1 1-1z" fill={col} opacity="0.9"/><rect x="3" y="6" width="14" height="11" rx="1" fill={col} opacity="0.15"/><line x1="6" y1="10" x2="14" y2="10" stroke={col} strokeWidth="1.5" strokeLinecap="round"/><line x1="6" y1="13" x2="11" y2="13" stroke={col} strokeWidth="1.5" strokeLinecap="round"/></svg></div>

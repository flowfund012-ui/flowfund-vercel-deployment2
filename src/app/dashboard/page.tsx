...
const MODULES=[
  ...
  {href:'/dashboard/vault',label:'Vault',desc:'Premium resources',color:'#00f0ff',icon:'V'},{href:'/dashboard/debts',label:'Debt Planner',desc:'AI payoff strategy',color:'#ef4444',icon:'X'},
